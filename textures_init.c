...
/*   Updated: 2023/06/23 23:42:11 by hferjani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    init_north(t_data *data)
{
    ...
    data->wall_north.addr = (int*)mlx_get_data_addr(data->wall_north.img,
        &data->wall_north.bits_per_pixel, &data->wall_north.line_length,
...
void    init_south(t_data *data)
{
    ...
    data->wall_south.addr = (int*)mlx_get_data_addr(data->wall_south.img,
        &data->wall_south.bits_per_pixel, &data->wall_south.line_length,
...
void    init_west(t_data *data)
{
    ...
    data->wall_west.addr = (int*)mlx_get_data_addr(data->wall_west.img,
        &data->wall_west.bits_per_pixel, &data->wall_west.line_length,
...
void    init_east(t_data *data)
{
    ...
    data->wall_east.addr = (int*)mlx_get_data_addr(data->wall_east.img,
        &data->wall_east.bits_per_pixel, &data->wall_east.line_length,
...
//     data->img.img_ptr = mlx_new_image(data->mlx_ptr, DISPLAY_WIDTH, DISPLAY_HEIGHT);
//     if(!data->img.img_ptr)
//     {
//         msg_err("img.img_ptr = mlx_new_image() failed", NULL);
//         exit_game(data);
//     }
